...
void main() async {
  ...
  runApp(new DetailLampiranPage());
}

class DetailLampiranPage extends StatelessWidget {
  @override
...
class MyDetailLampiranPage extends StatefulWidget with WidgetsBindingObserver {
  final TargetPlatform? platform;

  MyDetailLampiranPage({Key? key, this.title, this.platform}) : super(key: key);

  final String? title;

  @override
  _MyDetailLampiranPageState createState() => new _MyDetailLampiranPageState();
}

class _MyDetailLampiranPageState extends State<MyDetailLampiranPage> {
  final _documents = [
    {
