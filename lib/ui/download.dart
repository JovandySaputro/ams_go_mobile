...
import 'dart:async';
import 'dart:io';
import 'package:ams_go_mobile/data/download/task_info.dart';
...
class MyDownloaderPage extends StatefulWidget with WidgetsBindingObserver {
  final TargetPlatform? platform;

  MyDownloaderPage({Key? key, this.title, this.platform}) : super(key: key);

  final String? title;

  @override
  _MyDownloaderPageState createState() => new _MyDownloaderPageState();
}

class _MyDownloaderPageState extends State<MyDownloaderPage> {
  final _documents = [
    {
